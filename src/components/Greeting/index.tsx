  ...
  return (
    <Container>
      ...
      >
        ...
        <Text>
          {` I'm ${title}, a React TypeScript software engineer based in
        ...
        <Text style={{ color: "#0bd2d3" }}>
          ...
          sharing knowledge, I am dedicated to helping others excel in the
          dynamic realm of web development. Open to new opportunities, I also
          take on freelance work to contribute my skills to exciting projects.
        </Text>
      </motion.div>
    </Container>
  );
